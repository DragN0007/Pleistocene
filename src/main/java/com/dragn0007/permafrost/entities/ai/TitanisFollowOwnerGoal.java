...
public class TitanisFollowOwnerGoal extends Goal {
   public final Titanis tamable;
   ...
   public TitanisFollowOwnerGoal(Titanis p_25294_, double v, float p_25296_, float p_25297_, boolean p_25298_) {
