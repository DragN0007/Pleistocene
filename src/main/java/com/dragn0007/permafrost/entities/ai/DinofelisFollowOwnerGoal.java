...
public class DinofelisFollowOwnerGoal extends Goal {
   public final Dinofelis tamable;
   ...
   public DinofelisFollowOwnerGoal(Dinofelis p_25294_, double v, float p_25296_, float p_25297_, boolean p_25298_) {
