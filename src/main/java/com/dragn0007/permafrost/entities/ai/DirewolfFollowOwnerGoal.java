...
public class DirewolfFollowOwnerGoal extends Goal {
   private final Direwolf tamable;
   ...
   public DirewolfFollowOwnerGoal(Direwolf p_25294_, double v, float p_25296_, float p_25297_, boolean p_25298_) {
